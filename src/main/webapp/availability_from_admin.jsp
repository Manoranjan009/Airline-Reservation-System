                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                               ...
                               <a href="show_booking_list_a.jsp" class="nav-item nav-link"><small>Booking List</small></a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The website and backend mechanism are designed and developed by <a class="text-dark fw-medium" href="https://www.facebook.com/AlphaTanmoy/">our ARS team members</a> hope it's attractive and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Contact</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>CIME , Mancheswar Industrial Estate , Bhubaneswar</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 8093685218</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>manoranjan@gmail.com</p>
