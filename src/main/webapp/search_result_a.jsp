                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The website and backend mechanism are designed and developed by <a class="text-dark fw-medium" href="https://www.facebook.com">our ARS team member</a> hope it's attractive and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
