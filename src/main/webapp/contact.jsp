                    ...
                    <div class="row gx-0 bg-white d-none d-lg-flex">
                        <div class="col-lg-7 px-5 text-start">
                            <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                                ...
                                <p class="mb-0">manoranjan@gmail.com</p>
                            </div>
                            <div class="h-100 d-inline-flex align-items-center py-2">
                                <i class="fa fa-phone-alt text-primary me-2"></i>
                                <p class="mb-0">+91 8093685218</p>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>deepti@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                                <h6 class="section-title text-start text-primary text-uppercase">General</h6>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>priti@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                                <h6 class="section-title text-start text-primary text-uppercase">Technical</h6>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>manoranjan@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3741.7684180142287!2d85.85060977447446!3d20.309850581165616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a190a2160eb8df9%3A0x1ef6fe7025146ac7!2sCIME!5e0!3m2!1sen!2sin!4v1712220900547!5m2!1sen!2sin"
