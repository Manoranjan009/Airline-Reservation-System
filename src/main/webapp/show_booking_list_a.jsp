    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/search.png);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Showing Booking List</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="admin_login_pass.jsp">Home</a></li>
                            <li class="breadcrumb-item text-white" aria-current="page">Booking List</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Showing Booking List <span class="text-primary text-uppercase">Successful</span></h1>
            </div>
        </div>
        ...
        <!-- Footer Gapping -->
        <h2 align="center"><font><strong>Showing  Results</strong></font></h2>
        <div class="scroll" style="margin-bottom:150px;">
        <%
