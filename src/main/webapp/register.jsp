...
<body>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <!---Login Section -->
        <div class="container-xxl py-5" style="margin:70px;">
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="registration">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-8">
                                         <div class="form-floating">
                                            <input type="number" class="form-control" name="phno" id="phno" placeholder="Enter Your Number" pattern="[0-9]{10}" title="please enter 10 digits "  required>
                                            <label for="phno">Enter Your 10 Digit Phone Number</label>
                                        </div> 
        ...
        <!-- Footer Start -->
        <div class="container-fluid bg-dark text-light footer wow fadeIn" data-wow-delay="0.1s"  style="padding-top:30px;">
