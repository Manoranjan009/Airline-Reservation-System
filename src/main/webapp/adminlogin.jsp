                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="adminname" name="admin_name" placeholder="Admin Name" required>
                                            <label for="adminname">Admin Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="password" class="form-control" id="adminpass" name="admin_pass" placeholder="Admin Pass" required>
